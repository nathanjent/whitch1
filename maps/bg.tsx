...
<tileset version="1.10" tiledversion="1.10.2" name="bg" tilewidth="8" tileheight="8" tilecount="1024" columns="32">
 ...
 <wangsets>
  <wangset name="ground-grassy" type="mixed" tile="-1">
   ...
   <wangtile tileid="4" wangid="0,0,2,1,2,0,0,0"/>
   <wangtile tileid="5" wangid="0,0,2,1,1,1,2,0"/>
   <wangtile tileid="6" wangid="0,0,2,1,1,1,2,0"/>
   <wangtile tileid="7" wangid="0,0,2,1,1,1,2,0"/>
   <wangtile tileid="8" wangid="0,0,0,0,2,1,2,0"/>
   <wangtile tileid="36" wangid="2,1,1,1,2,0,0,0"/>
   ...
   <wangtile tileid="40" wangid="2,0,0,0,2,1,1,1"/>
   <wangtile tileid="68" wangid="2,1,1,1,1,1,2,0"/>
   <wangtile tileid="69" wangid="1,1,0,0,0,1,1,1"/>
   <wangtile tileid="70" wangid="1,1,1,1,0,0,0,1"/>
   <wangtile tileid="71" wangid="1,1,1,1,1,1,1,1"/>
   <wangtile tileid="72" wangid="2,0,2,1,1,1,1,1"/>
